...
def create_reconstruction_networks():
    ...
    deconvs = [
        d.FourierNet3D(
            ...
            conv_fmap_nums=[
                int(int(640 / num_scopes) / int(subsampled_num_planes / num_scopes)),
                1,
            ],
            imbn_momentum=0.1,
...
def create_test_extents():
    ...
    extents = [
        [
            ((0, subsampled_num_planes), (280, 280 + length), (0, length)),
            ((0, subsampled_num_planes), (280, 280 + length), (0, length)),
        ],
        [
            ((0, subsampled_num_planes), (280, 280 + length), (0, length)),
        ...
        [
            ((0, subsampled_num_planes), (190, 190 + length), (0, length)),
            ((0, subsampled_num_planes), (190, 190 + length), (0, length)),
        ],
        [
            ((0, subsampled_num_planes), (200, 200 + length), (0, length)),
            ((0, subsampled_num_planes), (200, 200 + length), (0, length)),
        ],
        [
            ((0, subsampled_num_planes), (155, 155 + length), (0, length)),
            ((0, subsampled_num_planes), (155, 155 + length), (0, length)),
        ],
        [
            ((0, subsampled_num_planes), (190, 190 + length), (0, length)),
        ...
        [
            ((0, subsampled_num_planes), (230, 230 + length), (0, length)),
            ((0, subsampled_num_planes), (230, 230 + length), (0, length)),
        ],
        [
            ((0, subsampled_num_planes), (230, 230 + length), (0, length)),
        ...
        [
            ((0, subsampled_num_planes), (240, 240 + length), (0, length)),
            ((0, subsampled_num_planes), (240, 240 + length), (0, length)),
        ],
    ]
    return extents
...
def train():
    ...
    phase_mask_init = torch.load(
        "../psf_optimization/snapshots/phase_mask580000.pt", map_location=devices[0]
    )
