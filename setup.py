...
# Execute version file to get version, avoiding import of dependencies
exec(open("./snapshotscope/version.py").read())
...
setup(
    ...
    # Author details
    author="Diptodip Deb, Srini Turaga, Kaspar Podgorski",
    # Choose your license
    license="MIT",
    ...
    keywords="simulation, computational microscopy, machine learning",
